...
public class TenantsController {
	...
	public ResponseEntity<ApiResponse> isCanRemove(@PathVariable Integer id) {
		final Boolean result = tenantsServices.isCanRemoveTenant(id);
		return ResponseEntity.status(HttpStatus.OK).body(new ApiResponse(true, result, Constants.GET_SUCESS_MSG));
	}
	
	@DeleteMapping("/{id}")
	public ResponseEntity<ApiResponse> removeTenant(@PathVariable Integer id) {
		final Boolean result = tenantsServices.removeTenant(id);
		return ResponseEntity.status(HttpStatus.OK).body(new ApiResponse(true, result, Constants.GET_SUCESS_MSG));
	}
